            ...
            <div className="w-full lg:w-1/3 mb-16 lg:mb-0">
              <div className="flex justify-center lg:justify-start items-center">
                <div className="text-white font-['Inter'] font-bold text-xl">
                  © PT. Blockchain4indonesia. All Rights Reserved.
                </div>
              </div>
              <p className="mb-10 mt-4 sm:w-[22rem] lg:w-[20rem] xl:w-[24rem] text-gray-400 leading-loose text-center lg:text-left mx-auto lg:mx-0">
                We are a team of blockchain enthusiasts who are passionate about 
                the potential of blockchain technology to revolutionize the way 
                we do business.
              </p>
            ...
            <div className="w-full lg:w-2/3 lg:pl-16 hidden lg:flex flex-wrap justify-between">
              <div className="w-full md:w-1/3 lg:w-auto mb-16 md:mb-0">
                <h3 className="mb-6 text-2xl font-bold text-primaryText">
                  You can ask question here all you want
                </h3>
