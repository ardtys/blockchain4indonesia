...
const solutionsData = [
  ...
  },
  {
    ...
    description: "Take a role in maximizing the potential blockchain has on plantation, agriculture and fisheries industries.",
    image: "/api/placeholder/400/320",
    stats: {
      symbol: "BTC",
      price: "$6780",
        ...
        <div className="container px-4 mb-20">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="w-full md:w-1/2 lg:w-2/5">
              <div className="bg-white bg-opacity-5 rounded-3xl p-8">
                <div className="h-64 mb-8 relative bg-[#89B3A8] bg-opacity-20 rounded-2xl overflow-hidden">
                  <div className="absolute top-4 right-4 bg-black bg-opacity-50 text-white px-2 py-1 rounded-lg text-sm">
                    ↑ {solutionsData[0].stats.percentage}
                  </div>
                  <div className="absolute bottom-4 left-4 flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-white">{solutionsData[0].stats.count}</div>
                      <div className="text-sm text-gray-300">{solutionsData[0].stats.label}</div>
                      <div className="text-xs text-[#89B3A8]">{solutionsData[0].stats.growth}</div>
                    </div>
                  </div>
                </div>
            ...
            <div className="w-full flex flex-col md:flex-row justify-center gap-8">
              {solutionsData.slice(1).map((solution, index) => (
                <div key={index} className="w-full md:w-1/2 lg:w-2/5">
                  <div className="bg-white bg-opacity-5 rounded-3xl p-8">
                    <div className="h-64 mb-8 relative bg-[#89B3A8] bg-opacity-20 rounded-2xl overflow-hidden">
