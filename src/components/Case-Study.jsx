...
const blogData = [
  {
    ...
    subtitle:
      "Discover insights and trends in blockchain technology.",
    image: blog1.src,
  },
  {
    title: "What is MLETR?",
    subtitle: "Learn about the importance of MLETR in the industry.",
    image: blog2.src,
  },
  {
    title: "Solving the 2.5 Trillion Trade Finance Gap",
    subtitle: "Learn how blockchain can solve the trade finance gap.",
    image: blog3.src,
  },
];
      ...
      >
        <div className="container px-4 mb-20">
          <div className="max-w-2xl text-center lg:text-left mb-16 mx-auto lg:ml-0 lg:mr-0">
            <span className="block-subtitle">Our Case Study</span>
            ...
            <div className="hidden sm:flex mx-auto lg:ml-0 lg:mr-0 w-11/12 sm:w-4/5 lg:w-1/2 xl:w-2/5 px-4 flex-col justify-between h-full">
              ...
              >
                ...
                <img
                  ...
                  aria-label={blogData[1].title}
                />
              </a>
              <a
                href="/blog/solving"
                key={blogData[2].title}
                className="flex gap-4 p-10 bg-bgDark3 rounded-3xl min-h-1/2 h-1/2 max-h-[47%] hover:bg-bgDark3Hover transition cursor-pointer"
              >
                <div className="pt-2">
                  <h3 className="mb-4 text-xl font-bold font-heading text-primaryText">
